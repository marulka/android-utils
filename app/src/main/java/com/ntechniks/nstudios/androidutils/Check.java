...
public class Check {
	 ...
	 * @param variableName
	 *            {@link String} - The variable name and variable type.
	 * @param methodName
	 *            {@link String} - The name of the method caller.
	 * @param obj
	 *            {@link Object} - The variable you want to check for null
	 *            pointer.
	 ...
	 *            {@link String} - The name of the method caller.
	 * @param str
	 *            {@link Object} - The {@link String} variable you want to
	 *            check.
	 * @return boolean - Returns true, if the variable does NOT have Null
	 ...
	 *            {@link String} - The name of the method caller.
	 * @param basicVariable
	 *            int - The integer variable which will be checked if it is
